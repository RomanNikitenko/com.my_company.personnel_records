...
// ***************************************************************************
	/**
	 * Метод читает данные для меню "Company Data" и заносит в
	 * ArrayList<ArrayList<String>>. Работа метода основана на считывании инфо,
	 * которая идет после ключевого слова
	 * 
	 * @param pathFileIn
	 *            String - путь к файлу
	...
	public static ArrayList<ArrayList<String>> readCompanyDataFromFile(String pathFileIn) {
		...
		// *******//читаем построчно файл, делаем анализ инфо и заполняем массив
		// данных
